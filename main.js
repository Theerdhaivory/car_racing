...
function car1_down(){
	if(car1_y <= 500){
		car1_y = car1_y + 10;
		console.log("when down arrrow is pressed, x = "+car1_x+"  | y =" +car1_y);
		uploadBackground()
		uploadcar1();
		uploadcar2();
	}
...
function car1_right(){
	if(car1_x <= 700){
		car1_x = car1_x +10;
		console.log("when right arrrow is pressed, x = "+car1_x+"  | y =" +car1_y);
		uploadBackground()
		uploadcar1();
		uploadcar2();
	}
...
function car2_up(){
	if(car2_y >= 0){
		car2_y = car2_y -10;
		console.log("when up arrrow is pressed,   x="+car2_x+"  | y =" +car2_y);
		uploadBackground()
		uploadcar1();
		uploadcar2();
	}
...
function car2_down(){
	if(car2_y <= 500){
		car2_y = car2_y+ 10;
		console.log("when down arrrow is pressed, x = "+car2_x+"  | y =" +car2_y);
		uploadBackground()
		uploadcar1();
		uploadcar2();
	}
...
function car2_left(){
	if(car2_x >= 0){
		car2_x = car2_x -10;
		console.log("when left arrrow is pressed, x = "+car2_x+"  | y =" +car2_y);
		uploadBackground()
		uploadcar1();
		uploadcar2();
	}
...
function car2_right(){
	if(car2_x <= 700){
		car2_x = car2_x +10;
		console.log("when right arrrow is pressed, x = "+car2_x+"  | y =" +car2_y);
		uploadBackground()
		uploadcar1();
		uploadcar2();
	}
